...
PROMPTS = [
    ...
    "Prepare a tweet to promote Clarifai's vector search capabilities. Only output the raw text of the example. Do not include instructions. Include the hashtag '#Clarifai'. Include the relevant link: `https://www.clarifai.com/use-cases/visual-search`. Limit the entire example to 260 characters including the link.",
    "Prepare a tweet to promote Clarifai's generative AI capabilities. Only output the raw text of the example. Do not include instructions. Include the hashtag '#Clarifai'. Include the relevant link: `https://www.clarifai.com/products/generative-ai`. Limit the entire example to 260 characters including the link.",
